...
This is the review of the original input; the v2 local companion it describes was retired in v3. See ARCHITECTURE.md and CHANGELOG.md for the implemented OAuth architecture.
